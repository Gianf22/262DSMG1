...
fun SportsListAndDetails(
    ...
    Row(
        ...
        // Lado izquierdo: Lista de deportes
        SportsList(
            sports = sports,
            onClick = onClick,
            modifier = Modifier
        ...
        // Lado derecho: Detalle del deporte seleccionado actualmente
        SportsDetail(
            selectedSport = selectedSport,
            modifier = Modifier.weight(1f),
            onBackPressed = {}, // En pantalla expandida no hace falta botón volver interno
            contentPadding = contentPadding
        )
    }
}
